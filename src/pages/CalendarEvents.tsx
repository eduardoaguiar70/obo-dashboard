    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex-1 bg-surface border border-border rounded-lg overflow-hidden h-[600px] shadow-sm">
                <iframe
                    src="https://calendar.google.com/calendar/embed?height=600&wkst=1&ctz=America%2FBelem&showPrint=0&src=Y2EwMjA5ODNiZjRhZDE0YWVkZTA3ZTJkZjRmZTUzZGI2NGU2MzZmNzA2NzQ4ZTI0M2Q1NDQ2NjRjZTI1YmNlNkBncm91cC5jYWxlbmRhci5nb29nbGUuY29t&color=%232952a3"
                    style={{ borderWidth: 0 }}
                    width="100%"
                    height="100%"
                    frameBorder="0"
